...
<body link="#00486C" alink="#00486C" vlink="#00486C">
    ...
    <div id="navigation">
        ...
        <br/>
        <a href="../vue/monCompteMesDonneesPerso.html">Mes donées personnelles </a>
        <br/>
        <a href="../vue/monCompteMesEmprunts.html">Mes emprunts </a>
        <br/>
        <a href="../vue/monCompteMesReservation.html">Mes réservation </a>
        <br/>
        <br>
    </div>
    <div id="section">
