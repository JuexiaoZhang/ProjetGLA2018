		...
		public function __construct() {
			...
			switch($ctp)
			{
				...
				case 11 :
					...
					$req = "INSERT INTO article (titre, auteur, datePublication, photo, fraisEmprunt, caution, description, type) VALUES ('".$titre."', '".$auteur."', '".$dateYear."-".$dateMonth."-".$dateDay."', '".$urlPhoto."', ".$frais.", ".$caution.", '".$description."', '".$type."')";
