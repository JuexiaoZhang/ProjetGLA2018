...
--
-- Host: localhost
-- Generation Time: 2018-05-22 21:51:47
...
(5, 'test2', 'auteurtest2', '1111-11-11', 'testurl', 20, 20, 'hahaha', 'livre'),
(6, 'test4', 'auteurtest2', '2000-11-12', 'mnjkdn', 2, 20, ' njnddjbfhjd', 'livre'),
(7, 'test5', 'auteurtest2', '1345-01-11', 'aze', 2, 20, ' hcuidsqhfq', 'livre'),
(11, 'test11', 'auteurtest2', '1995-04-12', 'dnjdj', 2, 20, ' jfzk', 'album'),
(13, 'nouvelle titre', 'auteurtest2', '0000-00-00', 'njkz', 2, 20, ' jkdd', 'video');
...
(2, '123456', 'zhang.juexiao@gmail.com', 'Juexiao', 'ZHANG', 1, 'utilisateur', 20, 80),
...
(1, '2018-05-07', 1, 1, 1, 2),
(2, '2018-05-07', 2, 1, 1, 2),
(3, '2018-05-02', 4, 1, 1, 2),
...
--
-- 使用表AUTO_INCREMENT `emprunt`
--
ALTER TABLE `emprunt`
  MODIFY `idEmprunt` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- 使用表AUTO_INCREMENT `exemplaire`
--
ALTER TABLE `exemplaire`
...
--
ALTER TABLE `reservation`
  MODIFY `idReservation` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- 限制导出的表
--
